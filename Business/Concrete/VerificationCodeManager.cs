...
using Core.Aspects.Autofac.Logging;
using ResetPassword = Entities.Models.ResetPassword;
...
namespace Business.Concrete
{
    public class VerificationCodeManager : IVerificationCodeService
    {
        ...
        public IResult SendCodeForgotPassword(Microsoft.VisualStudio.Web.CodeGenerators.Mvc.Templates.BlazorIdentity.Pages.ResetPassword resetPassword)
        {
            throw new NotImplementedException();
        }

        public IResult CheckCodeForgotPassword(Microsoft.VisualStudio.Web.CodeGenerators.Mvc.Templates.BlazorIdentity.Pages.ResetPassword resetPassword)
        {
            throw new NotImplementedException();
        }
    }
