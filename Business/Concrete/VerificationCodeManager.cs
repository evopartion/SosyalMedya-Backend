...
namespace Business.Concrete
{
    ...
    {
        private readonly IVerificationDal _verificationCodeDal;
        private readonly IUserDal _userDal;
        private readonly TimeSpan _expirationTime = TimeSpan.FromMinutes(3);

        public VerificationCodeManager(IVerificationDal verificationCodeDal, IUserDal userDal)
        {
        ...
        private IResult SendMail(string Email, string randomCode)
        {
            ...
            using (var client = new MailKit.Net.Smtp.SmtpClient())
            {
                ...
                client.Authenticate("sefaceliktu@gmail.com", "");
